/**
 * OCR Web Worker with Absolute URLs
 * Based on proven solutions from Tesseract.js GitHub issues
 * Uses absolute URLs to fix importScripts invalid URL errors
 */
...
// Import Tesseract.js using absolute URL
try {
...
/**
 * Initialize worker using absolute URLs
 */
async function initializeWorker(language, _config, _ocrSettings) {
  try {
    ...
    // Create worker using absolute URLs (proven solution)
